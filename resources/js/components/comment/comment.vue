<template>
    ...
    <div class="container-fluid" v style="background-color: #efefef; padding-left: 5%; padding-right: 15%; padding-bottom: 15%;">
        ...
        <div class="row">
            <div class="col-sm">
                <button type="button" class="btn" style="color: white; background-color: #fe6261; float: right;">
        ...
        <div class="row" style="background-color: #333333; color: white; padding: 2%;">
            ...
            <div v-for="comment in comments" :key="id">
                <div class="row">
                    <div class="col-sm-1">
    ...
    export default{
        ...
        methods:{
            ...
            async mostrarComments(){
                await this.axios.get(url_api+'/api/comments', {headers:{'Authorization': 'Bearer '+this.$route.params.api}})
                    .then(response => {
